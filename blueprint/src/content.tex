...
\begin{remark}
This result is proven as Theorem 1.1 in the \href{../paper/chebyshev_circles.pdf}{research paper}.
\end{remark}
\end{theorem}
...
\textit{(See Lemma 2.2 in \href{../paper/chebyshev_circles.pdf}{the paper})}
\end{lemma}
...
\textit{(See Theorem 2.3 in \href{../paper/chebyshev_circles.pdf}{the paper})}
\end{theorem}
...
\textit{(See Theorem 4.1 in \href{../paper/chebyshev_circles.pdf}{the paper})}
\end{theorem}
